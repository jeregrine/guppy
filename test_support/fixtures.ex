...
defmodule Guppy.TemplateExample do
  ...
  def render(assigns) do
    ...
    <div id="root" tooltip="Template root" animation={@root_animation} class="flex flex-col gap-4 p-4 bg-[#0f172a] text-[#f8fafc]">
      ...
      <data_table id="task_table" columns={@table_columns} rows={@table_rows} selected_row_id={@selected_row_id} selected_cell={@selected_cell} sort_state={@table_sort} class="h-[140px]" header_class="p-2" row_class="border-b-1" cell_class="p-2" row_click="table_row_clicked" cell_click="table_cell_clicked" sort="table_sorted" column_reorder="table_column_reordered" row_context_menu="table_row_context" cell_context_menu="table_cell_context" />
