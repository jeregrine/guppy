...
1. Scope full data-table/tree virtualization separately from current grid/list support.
2. Scope custom painting/canvas/pattern painting after narrower compliance gaps matter in practice.
