...
- [x] Define focus scopes and roving-focus patterns for list/tree/table/menu-like widgets: documented in `docs/focus-keyboard.md` with current table/tree/select/list behavior and deferred gaps; list rows with click/context-menu callbacks are keyboard-actionable.
