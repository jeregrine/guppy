defmodule Guppy.IRTest do
  ...
  test "ir validation accepts canonical box spacing style ops" do
    style = [
      ...
      {:text_size, {:px, 14}},
      {:line_height, :relaxed},
      {:line_height_length, {:fraction, 1.4}},
      {:font_weight, :bold},
    ...
    for invalid <- [
          ...
          {:shadow, :huge},
          {:box_shadow, [color: :red, x: 0, y: 2, blur: 4, spread: -1]},
          {:box_shadow, [[color: :purple, x: 0, y: 2, blur: 4, spread: -1]]},
          {:box_shadow, [[color: :red, x: 0, y: 2, blur: -4, spread: -1]]},
          ...
          {:text_overflow, :clip},
          {:font_size, :huge},
          {:text_size, {:fraction, 1}},
          {:text_size, {:px, -1}},
          {:line_height, :bad},
          {:line_height_length, :auto},
          {:line_height_length, {:px, -1}},
          {:font_weight, :heavy},
          {:font_weight_value, 50},
          {:font_style, :oblique},
          {:font_fallbacks, []},
          {:font_fallbacks, [""]},
          {:font_features, []},
